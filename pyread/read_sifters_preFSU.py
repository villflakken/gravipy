...
class Sifters(object):
    ...
    def fof_ids_sifter(self, f, i, skip):
        ...
        if Nids > 0:
            ...
            self.IDs = self.IDs - N.int64(1) # correction for indexation purposes
            pass
    ...
    def sub_tab_sifter_new(self, f, SubLen, SubOffset, M200, count, count_sub, pos, skip, i):
        """
    ...
    def sub_ids_sifter_new(self, SubLen, skip):
        """
    ...
    def sub_tab_sifter_old(self, f, SubLen, SubOffset, M200, count, count_sub, pos, skip, i):
        """
        Sifts through tab files.
        Collects identifications of no. of sub halos and structures?
        """
    ...
    def sub_ids_sifter_old(self, SubLen, skip):
        """
        Sifts through ID files.
        Collects IDs. I guess?
        """
